...
export function InstalledPacksList({ packs, isLoading, onRefresh }: InstalledPacksListProps) {
        ...
        <div className={styles.container}>
            ...
            {packs.length === 0 ? (
                <div className={styles.emptyState}>
                    ...
                    <p className={styles.emptyHint}>Import and install addons to see them here</p>
                </div>
            ) : (
